...
var require_react_simple_chatbot = __commonJS({
  "node_modules/react-simple-chatbot/dist/react-simple-chatbot.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t(require_react(), (init_styled_components_browser_esm(), styled_components_browser_esm_exports)) : typeof define == "function" && define.amd ? define(["react", "styled-components"], t) : typeof exports == "object" ? exports.ReactSimpleChatbot = t(require_react(), (init_styled_components_browser_esm(), styled_components_browser_esm_exports)) : e.ReactSimpleChatbot = t(e.react, e["styled-components"]);
    }(typeof self != "undefined" ? self : exports, function(e, t) {
      return function(e2) {
        var t2 = {};
        function n(r) {
          if (t2[r])
        ...
        return n.m = e2, n.c = t2, n.d = function(e3, t3, r) {
          ...
          if (n.r(r), Object.defineProperty(r, "default", { enumerable: true, value: e3 }), 2 & t3 && typeof e3 != "string")
            for (var o in e3)
              n.d(r, o, function(t4) {
                return e3[t4];
              }.bind(null, o));
        ...
        var n = function(e3, t3) {
          return { parse: function(t4, r2) {
            var a = JSON.parse(t4, i).map(o), s = a[0], u = r2 || n2, c = typeof s == "object" && s ? function t5(n3, r3, o2, i2) {
              return Object.keys(o2).reduce(function(o3, a2) {
                var s2 = o3[a2];
                if (s2 instanceof e3) {
                  var u2 = n3[s2];
                  typeof u2 != "object" || r3.has(u2) ? o3[a2] = i2.call(o3, a2, u2) : (r3.add(u2), o3[a2] = i2.call(o3, a2, t5(n3, r3, u2, i2)));
                } else
            ...
            for (var a, s = new Map(), u = [], c = [], l = o2 && typeof o2 == typeof u ? function(e5, t4) {
        ...
        var r = n(1), o = n.n(r), i = n(0), a = n.n(i), s = n(4), u = n.n(s), c = n(2), l = n.n(c), p = function(e3) {
          var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, n2 = function(e4) {
        ...
        var R = function(e3) {
          function t3() {
            ...
            for (var a3 = arguments.length, s2 = new Array(a3), u2 = 0; u2 < a3; u2++)
              s2[u2] = arguments[u2];
            return r2 = this, i3 = (e4 = P(t3)).call.apply(e4, [this].concat(s2)), n3 = !i3 || k(i3) !== "object" && typeof i3 != "function" ? q(r2) : i3, C(q(q(n3)), "state", { loading: true }), C(q(q(n3)), "renderComponent", function() {
        ...
        var Y = function(e3) {
          function t3() {
            ...
            for (var a3 = arguments.length, s2 = new Array(a3), u2 = 0; u2 < a3; u2++)
              s2[u2] = arguments[u2];
            return r2 = this, i3 = (e4 = K(t3)).call.apply(e4, [this].concat(s2)), n3 = !i3 || U(i3) !== "object" && typeof i3 != "function" ? W(r2) : i3, $(W(W(n3)), "onOptionClick", function(e5) {
              var t4 = e5.value;
        ...
        function ae(e3) {
          return (ae = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && typeof Symbol == "function" && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          })(e3);
        ...
        var fe = function(e3) {
          function t3() {
            ...
            for (var a3 = arguments.length, s2 = new Array(a3), u2 = 0; u2 < a3; u2++)
              s2[u2] = arguments[u2];
            return r2 = this, i3 = (e4 = ue(t3)).call.apply(e4, [this].concat(s2)), n3 = !i3 || ae(i3) !== "object" && typeof i3 != "function" ? le(r2) : i3, pe(le(le(n3)), "state", { loading: true }), pe(le(le(n3)), "getMessage", function() {
        ...
        var xe = { parse: function(e3) {
          ...
          for (var n2 = 0, r2 = t3.length; n2 < r2; n2 += 1) {
            ...
            if (e3[i2] && a2[0] !== "any" && a2.indexOf(Se(e3[i2])) < 0)
            ...
            if (typeof r2 != "function") {
              if (n2.options)
                for (var o2 = n2.options.filter(function(e4) {
                  return typeof e4.trigger != "function";
                }).map(function(e4) {
                  return e4.trigger;
        ...
        var tt = null, nt = function() {
          ...
          function e3() {
            var t3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : nt, n2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : nt, r2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : nt, o2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "en";
            return function(e4, t4) {
              if (!(e4 instanceof t4))
                throw new TypeError("Cannot call a class as a function");
        ...
        var ct = ut, lt = function() {
          ...
          return function(t3, n2) {
            ...
            if (window.SpeechSynthesisUtterance && window.speechSynthesis && !a2 && i2) {
              var s2 = function(e4) {
                var t4 = e4.message, n3 = e4.metadata, r3 = n3 === void 0 ? {} : n3;
        ...
        function dt(e3) {
          return (dt = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e4) {
            return typeof e4;
          } : function(e4) {
            return e4 && typeof Symbol == "function" && e4.constructor === Symbol && e4 !== Symbol.prototype ? "symbol" : typeof e4;
          })(e3);
        ...
        var St = function(e3) {
          function t3(e4) {
            ...
            return function(e5, t4) {
              if (!(e5 instanceof t4))
                throw new TypeError("Cannot call a class as a function");
            }(this, t3), r2 = this, i3 = gt(t3).call(this, e4), n3 = !i3 || dt(i3) !== "object" && typeof i3 != "function" ? vt(r2) : i3, mt(vt(vt(n3)), "onNodeInserted", function(e5) {
              ...
              return typeof e5 == "function" ? e5({ value: t4, steps: r3 }) : e5;
              ...
              return typeof e5 == "function" ? e5({ previousValue: i4, steps: o2 }) : e5;
              ...
              e5.key === "Enter" && n3.submitUserMessage();
              ...
              return (typeof i4 != "boolean" || !i4) && (n3.setState({ inputValue: i4.toString(), inputInvalid: true, disabled: true }, function() {
                setTimeout(function() {
          ...
          return function(e4, t4) {
            ...
            var n3 = e4.opened;
            return e4.toggleFloating !== void 0 && n3 !== void 0 && n3 !== t4.opened ? function(e5) {
              for (var t5 = 1; t5 < arguments.length; t5++) {
                var n4 = arguments[t5] != null ? arguments[t5] : {}, r2 = Object.keys(n4);
                typeof Object.getOwnPropertySymbols == "function" && (r2 = r2.concat(Object.getOwnPropertySymbols(n4).filter(function(e6) {
            ...
            if (v2.message) {
              var m2 = v2.message;
              v2.message = typeof m2 == "function" ? m2() : m2, l2[v2.id].message = v2.message;
            }
...
// dep:react-simple-chatbot
var react_simple_chatbot_default = require_react_simple_chatbot();
export {
  react_simple_chatbot_default as default
};
/*! *****************************************************************************
